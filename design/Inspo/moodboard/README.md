# Moodboard — aesthetic references (2026-09-01)

What each reference contributes is captured in `../VISION.md` → "Aesthetic direction".

## In this folder ✔

| File | Reference | What it contributes |
|---|---|---|
| `kef-ls50-wireless-ii.jpg` | KEF LS50 Wireless II, mineral white ([source](https://www.richersounds.com/kef-ls50-wireless-ii-mineral-white/)) | Concentric machined ribs radiating from a circle (→ underside / speaker aperture); circle-in-a-box reads hi-fi, not gadget; luminous copper accent on mono body |
| `totem-machined-caps.jpg` | Totem Automobili GT Super — knurled machined reservoir caps ([source](https://totemautomobili.com/gt-super)) | The knurl + engraved-function attitude: machined jewellery that is all function-shapes. Closest stand-in for the pasted central-lock shot |
