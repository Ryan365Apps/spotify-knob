...
| # | Question | Settled |
|---|---|---|
| 1 | Diameter | **Ø175.4 outside, bore Ø166.4** — re-ruled 6 Sep: a flat rim of at least 20 mm on the knob's top, the knob keeping v10's shape (4.5 wall), so the bore and everything inside scale out to the rim; the chin (r 72.05) no longer sets anything |
...
| 13 | Knurl | **78 starts** at Ø175.4 (the v9 7.1 mm pitch kept; 68 at Ø154), 37° helix, four whole rows |
