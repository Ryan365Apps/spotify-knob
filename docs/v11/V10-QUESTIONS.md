...
| 8 | Servo | *built differently*: on the deck, pushing a 28 mm carriage tab — no floor position exists in any azimuth with the Pi in the middle |
...
| 11 | Cooler | *built differently*: **heatsink on, fan off** — the fan's intake hole and the 65 × 64 adapter cannot share the deck; option B (Pi inverted on a plate boss) is the fallback if the first print runs hot |
| 12 | Halo LED count | **90** at r 74.3 |
| 13 | Knurl | **68 starts**, 33° helix, four whole rows |
...
| 17 | Adapter to panel flex | Ryan to confirm the 45-way mates (spec 4.3) |
| 18 | Board envelopes | audio 25 × 40 × 6; motion **30 × 30 × 7.4** (was 50 × 40 proposed); converter 38 × 25 × **8**; touch 30 × 20 × 3 stacked on the adapter |
...
---|---|---|---|---|
| 1 | 1 | Diameter: Ø154 with a plain bore, or Ø150 with an undercut | **Ø154** | |
| 2 | 2 | Approve the top ring at 13.5 mm (drawing) | approve | |
