...
assembly(True, "the60_v11_assembly")
assembly(False, "the60_v11_assembly_free_spin")
with open(os.path.join(pd, "README.txt"), "w") as f:
    f.write("the 60 - v11 - printable parts (print orientation; they will not assemble as exported)\n\n")
