"""v10 general arrangement: plan slices at four heights plus sections through the motor and the back."""
import os, math, sys
...
allp = {**made, **bought}
COL = {"base_plate": "0.45", "internal_structure": "#7a6a4a", "halo_diffuser": "#3a9ab0", "knob_body": "0.15", "deck": "#9a5a1a",
...
fig.suptitle(f"the 60 — v10 general arrangement.  Pi 5 on the pad through the plate window, mezzanine deck, 5-inch panel bonded to the seat, 8 mm plate.  "
...
fig.savefig(os.path.join(OUT, "v10_ga.png"), dpi=110)
print("wrote", os.path.join(OUT, "v10_ga.png"))
