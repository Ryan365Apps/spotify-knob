...
R_STRIP_BACK         = 73.2                            # the wall's outer face in the halo band (a 1.1 thick band on the wall) - outside the bell + band's reach (73.1), which the strip must clear
R_STRIP_IN, R_STRIP_OUT = R_STRIP_BACK + 0.1, R_STRIP_BACK + 0.1 + LED_STRIP_T   # 73.3 - 74.9
R_DIFF_IN            = R_STRIP_OUT + 0.2               # 75.1
R_DIFF_OUT_BOT       = 76.0                            # RULING 5 Sep review: a more exaggerated lean (1.0 over the band's 5.5)
R_DIFF_OUT_TOP       = R_KNOB                          # 77.0
DIFF_CHAMFER         = 0.50
R_LIP_OUT            = 76.0
PLATE_R              = R_KNOB                          # 77.0 - the plate's edge (the lands and blocks) is flush with the knob; RULING 5 Sep review 2: engine-turned edge
...
PLATE_CHAMFER        = 1.0                             # top and bottom outer edges (RULING 5 Sep review 2); the top one runs r 76.0-77.0, outside the diffuser's seat (r 75.1-76.0)
PAD_R                = 74.0                            # RULING 5 Sep review: pad slightly smaller than the plate (top face; 0.5 lean to the underside)
