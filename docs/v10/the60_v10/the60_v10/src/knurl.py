"""Diamond knurl on the v10 knob body's side.
...
KEY = (KNURL_N, KNURL_DEPTH, round(KNURL_HELIX_DEG, 3), KNURL_ROWS, KNURL_ROOT_OFF, KNURL_BANDS, KNURL_BAND_OV,
       ...
       WHEEL_V_FLAT, Z_RIDGE_MID, "v10", 1)
...
def knurl_band(r, z0, z1, z_ref, ov, dx=0.0):
    ...
    if i == 0:
        ...
        if 1 <= i <= nb:
            ...
            for attempt in range(4):
                cut = knurl_band(R_KNOB, za, zb, KNURL_Z0, ov, dx=0.02 * ((i - 1) % 2))
