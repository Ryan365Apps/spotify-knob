the 60 - v14 - printable parts (print orientation; they will not assemble as exported)
...
internal_structure   0.20 mm  upright on the wall foot. SUPPORTS in two places only: under the seat flange (r 62-81.2 at z 16 above the bed - a ring inside the wall, hidden face) and under the diffuser lip (r 83.9-86.7 at z 5.5 - a thin ring outside). Everything else self-supporting: open-topped windows, 1 mm slit roofs, 45 deg hole ends
...
base_plate_AL         CNC 6082 aluminium core r < 75.2: 4 web, 3 duct with 3 x 3 fin channels on a 4 pitch, ribs 6 tall on top; external faces black hard anodised, internal faces chromate or bare - no masked pads
rim_ring_STEEL        machined steel ring r 75.2-87.7 x 8: plain edge, 1.0 chamfers, inward flange onto the core, 21 intake + 6 exhaust grooves in its underside, 1.5 intake undercut front and sides
