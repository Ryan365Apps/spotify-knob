"""v14 general arrangement: plan slices at four heights plus sections through the motor and the back."""
import os, math, sys
...
fig.suptitle(f"the 60 — v14 general arrangement.  Pi 5 in the plate window on the closing plate, every board on the plate, adapter on the Pi's standoffs, 5-inch panel bonded to the seat.  "
...
fig.savefig(os.path.join(OUT, "v14_ga.png"), dpi=110)
print("wrote", os.path.join(OUT, "v14_ga.png"))
