...
12. **Reserve the envelope for a radial blower in the rear plenum, and do not fit the part.** A fin array is back-pressure and an axial fan stalls against it. Fitted or not is decided after measurement, not now.
...
15. **The compute module, the step-down converter and the motor driver mount to the plate**, on thermal gap pads. In production this means no mezzanine deck: the plate is the chassis.
