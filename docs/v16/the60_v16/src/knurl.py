"""Diamond knurl on the v16 knob body's side.
...
KEY = (KNURL_N, KNURL_DEPTH, round(KNURL_HELIX_DEG, 3), KNURL_ROWS, KNURL_ROOT_OFF, KNURL_BANDS, KNURL_BAND_OV,
       ...
       Z_CROWN_BOT, CH_BOT, CH_TOP, CH_IN, R_RELIEF, R_CREST, Z_RELIEF0, Z_RELIEF1, Z_RIDGE0, Z_RIDGE1,
       RIDGE_CREST_W, Z_RIDGE_MID, KNURL_RUNOUT_BOT, SKIRT_WALL, "v16", 1)
