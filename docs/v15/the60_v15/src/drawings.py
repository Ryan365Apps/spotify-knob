"""v15 general arrangement: plan slices at four heights plus sections through the motor and the back."""
import os, math, sys
...
fig.suptitle(f"the 60 — v15 general arrangement.  Pi 5 in the plate window on the closing plate, boards on the plate, the blower on the plate with the motion board on its saddle, adapter on the Pi's standoffs, 5-inch panel on the seat.  "
...
fig.savefig(os.path.join(OUT, "v15_ga.png"), dpi=110)
print("wrote", os.path.join(OUT, "v15_ga.png"))
