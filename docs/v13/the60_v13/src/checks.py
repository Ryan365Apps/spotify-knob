"""v13 automated checks: solidity, pairwise interference across EVERY body (made and bought)
...
tallest = []
for n, s in {**made, **bought_on}.items():
    if n in display or n.startswith("panel_flex") or n.startswith("touch_tail") or n.startswith("collar") or n.startswith("bush") or n.startswith("bearing") or n.startswith("nub") or n.startswith("encoder_"): continue
